...
규칙:
- 총 10문항, 모두 4지선다형 객관식 (type: "choice")
- q1~q4: 개념 이해 문제 — 학습 자료의 핵심 개념·정의·사실을 묻는 문제
- q5~q8: 개념 응용 문제 — 개념을 새로운 상황에 적용하거나 추론하는 문제
- q9~q10: 심화 문제 — 여러 개념을 통합하거나 비판적으로 분석하는 고난도 문제
- 각 문제는 4개 선택지 (A, B, C, D)
- id는 q1, q2, ... q10 형식
- 한국어로 작성
- 전문용어는 영어 병기
- 반드시 유효한 JSON만 출력하세요.`;
